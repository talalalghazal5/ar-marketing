  ...
  return (
    <div className="grid gap-6 md:grid-cols-[260px_minmax(0,1fr)] w-full">
      ...
      {items.length > 0 ? (
        ...
        <div className="flex min-h-60 items-center justify-center rounded-2xl border border-dashed border-border/60 bg-card/40 p-8 text-center text-muted-foreground font-thmanyah-subheading-sans">
